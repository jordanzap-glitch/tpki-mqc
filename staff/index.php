        ...
        <div class="content">
           ...
           <?php include "includes/navbar.php"; ?>
                            ...
                            <div class="col">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                        $sessionBranchId   = $_SESSION['branchId']   ?? '';
                                        $sessionBranchName = $_SESSION['branchName'] ?? 'N/A';
                                        ?>
                                        <div class="form-control d-flex align-items-center gap-2" style="cursor:default;opacity:.85;">
                                            <i class="fa fa-map-marker-alt" style="color:var(--primary)"></i>
                                            <span><?php echo htmlspecialchars($sessionBranchName); ?></span>
                                        </div>
                                        <input type="hidden" name="Branch_ID" id="branchIdHidden" value="<?php echo htmlspecialchars($sessionBranchId); ?>">
                                    </div>
                                    <div class="col-md-6">
            ...
            ?>;
                ...
                // BRANCH_MAP no longer needed (branch is auto-filled from session)
                var BRANCH_MAP = {};
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Branch is auto-filled from session; no wiring needed.
            });
