...
<head>
    ...
    /* Enhanced visibility for inputs and search on dependents records */
    .dataTables_wrapper .dataTables_filter input,
    #dependentsTable .form-control,
    ...
    #dependentsTable .form-control:focus,
    ...
    [data-theme="light"] #dependentsTable .form-control,
    ...
    [data-theme="light"] #dependentsTable .form-control:focus,
...
<body>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.edit-dependent-btn', function() {
            ...
            // find matching display value in datalist
            var found = '';
